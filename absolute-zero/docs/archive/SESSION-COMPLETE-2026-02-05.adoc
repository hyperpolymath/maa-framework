...
**Commit**: `cbeb34a` - fix: migrate to MPL-2.0 license

**Changes**:
* Added LICENSE file (MPL-2.0 full text)
...
**Commit**: `482892e` - fix: standardize to MPL-2.0 license
...
**Result**: Both repos consistently use MPL-2.0 ✅
