...
https://gitlab.com/maa-framework/6-the-foundation/aletheia[image:https://img.shields.io/badge/RSR-Bronze%20Compliant-green?style=flat-square&logo=rust[RSR
Bronze]]
...
https://gitlab.com/maa-framework/6-the-foundation/aletheia[image:https://img.shields.io/badge/RSR-Bronze%20In%20Progress-yellow?style=flat-square&logo=rust[RSR
Bronze]]
...
https://gitlab.com/maa-framework/6-the-foundation/aletheia[image:https://img.shields.io/badge/RSR-Not%20Compliant-red?style=flat-square&logo=rust[RSR
Bronze]]
...
In the future, Aletheia may support dynamic badges that automatically
update:
...
This would: 1. Run Aletheia verification 2. Generate badge with current
status 3. Update automatically on push
...
[arabic]
. *Run Aletheia*: `+aletheia .+`
. *Verify output*: Ensure 16/16 checks pass
. *Add badge*: Use appropriate badge code
. *Keep updated*: Re-verify after changes

=== Badge Hosting

Badges use shields.io service: - *Service*: https://shields.io -
...
Planned features: - Real-time verification API - Automatic badge
generation - Webhook integration - Historical compliance tracking -
Multi-repo dashboards

=== Contributing

Help improve RSR badges: - Suggest new badge designs - Propose dynamic
badge service - Contribute to Aletheia - Share badge usage examples
