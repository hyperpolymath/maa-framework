...
git clone https://github.com/hyperpolymath/maa-framework.git cd
maa-framework
...
toolbox create maa-framework-dev toolbox enter maa-framework-dev #
...
maa-framework/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
