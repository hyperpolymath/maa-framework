...
```scheme
;; SPDX-License-Identifier: MPL-2.0-or-later  ⚠️ Should be MPL-2.0
```
...
sed -i 's/MPL-2.0-or-later/MPL-2.0/' STATE.scm ECOSYSTEM.scm META.scm
