...
-- proofada — command-line entry point.
--
...
-- subset. The logic it calls lives in proofada.ads, which is SPARK and
...
procedure Main is
   ...
   Usage : constant String :=
     "proofada 0.1.0" & ASCII.LF &
     "" & ASCII.LF &
     "usage:" & ASCII.LF &
     "  proofada clamp <value> <lo> <hi>   clamp a value into a range" & ASCII.LF &
     "  proofada mid   <a> <b>             midpoint, rounded down (a <= b)" & ASCII.LF &
     "  proofada --help                    show this message" & ASCII.LF &
     "" & ASCII.LF &
