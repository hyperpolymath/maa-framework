...
See link:../[examples in Aletheia repository] for content templates.
...
*Solution*: 1. Check which files are missing (marked with ❌) 2. Create
missing files 3. Re-run verification
...
* Read ARCHITECTURE.md - Understand how Aletheia works
* Read RSR-SPECIFICATION.md - Learn RSR standards
* Read link:../../.github/CONTRIBUTING.md[CONTRIBUTING.md] - Contribute to Aletheia
...
_Start pursuing alētheia (truth) through rigorous standards!_
