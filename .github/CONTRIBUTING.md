...
# Contributing — maa-framework

## Audience

Developers working **on** `maa-framework`. For consumers (people calling
...
``` bash
git clone git@github.com:hyperpolymath/maa-framework.git
cd maa-framework
...
- Bugs in `maa-framework`: file at `hyperpolymath/maa-framework/issues`.
