...
// Replace maa-framework, {{BUILD_CMD}}, {{TEST_CMD}}, {{LANG_STACK}} with actuals
= maa-framework — Quick Start for Developers
:toc:
:toclevels: 2
...
cd maa-framework
git submodule update --init   # absolute-zero/ (pinned upstream proofs)
just setup-dev
----
